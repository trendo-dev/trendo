...
In order to support loading of multiple wallets in trendo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trendo.cpp.
...
Changes to trendo.cpp
----------------------
trendo.cpp is the entry point into trendo-qt, and as such, will require some minor modifications to provide hooks for
