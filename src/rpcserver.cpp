...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Trendo features */
        {"trendo", "masternode", &masternode, true, true, false},
        {"trendo", "listmasternodes", &listmasternodes, true, true, false},
        {"trendo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"trendo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"trendo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"trendo", "masternodedebug", &masternodedebug, true, true, false},
        {"trendo", "startmasternode", &startmasternode, true, true, false},
        {"trendo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"trendo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"trendo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"trendo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"trendo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"trendo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"trendo", "mnsync", &mnsync, true, true, false},
        {"trendo", "spork", &spork, true, true, false},
        {"trendo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"trendo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use trendod, or the -server option to trendo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> trendo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13663/\n";
}
