                                          ...
                                          walletModel(0)
{
    ...
    exportButton->setIcon(QIcon(":/icons/white_export"));
#endif
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    linkwPage->setWalletModel(walletModel);
...
void WalletView::gotoLinkwPage()
{
    setCurrentWidget(linkwPage);
}
