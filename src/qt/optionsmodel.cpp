...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::TRND);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePrjAmount"))
        SoftSetArg("-anonymizetrendoamount", settings.value("nAnonymizePrjAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in trendo.cpp during shotdown to also remove the window positions
