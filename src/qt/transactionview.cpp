...
#ifdef Q_OS_MAC
    dateWidget->setFixedWidth(23);
#else
    dateWidget->setFixedWidth(23);
#endif
    dateWidget->addItem(tr(""), All);
	////
*/
///
/*
    ...
    amountWidget->setPlaceholderText(tr(""));
#endif
#ifdef Q_OS_MAC
    amountWidget->setFixedWidth(23);
#else
    amountWidget->setFixedWidth(23);
#endif
...
///
    ...
    typeWidget->addItem(tr("POS"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint));
