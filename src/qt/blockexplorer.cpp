...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::TRND, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (trendo.conf).");
            QMessageBox::warning(this, "Trendo Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font: OpenSans; font-size:12px; color:#273645; bgcolor:#ffffff;}\n a, span {font: OpenSans; font-family: monospace; }\n span.addr {font: OpenSans; color:#ffffff; font-weight: bold;}\n table tr td {font: OpenSans; padding: 3px; border: 1px solid black; background-color: #ffffff;}\n td.d0 {font: OpenSans; font-weight: bold; color:#273645;}\n h2, h3 { font: OpenSans; white-space:nowrap; color:#273645;}\n a {font: OpenSans; color:#273645; text-decoration:none; }\n a.nav {font: OpenSans; color:#273645;}\n";
