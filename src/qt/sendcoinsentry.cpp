                                                  ...
                                                  model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a Trendo address TEBxEjGXmJxwpXxXAJqeXztdUR4MsZZJsE"));

#endif

    // normal trendo address field
   // GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying trendo address(es)
