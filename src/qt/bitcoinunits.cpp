...
// Copyright (c) 2017-2018 The TRND Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TRND);
   // unitlist.append(mTRND);
   // unitlist.append(uTRND);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case TRND:
            return QString("tTRND");
        case mTRND:
            return QString("mTRND");
        case uTRND:
            return QString::fromUtf8("μtTRND");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TRND:
            return QString("TRND");
        case mTRND:
            return QString("Milli-TRND (1 / 1" THIN_SP_UTF8 "000)");
        case uTRND:
            return QString("Micro-TRND (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TRND:
            return QString("TestTRNDs");
        case mTRND:
            return QString("Milli-TestTRNDs (1 / 1" THIN_SP_UTF8 "000)");
        case uTRND:
            return QString("Micro-TestTRNDs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
