...
/** Utility functions used by the Trendo Qt UI.
 */
namespace GUIUtil
{
...
// Render Trendo addresses in monospace font
...
// Parse "trendo:" URI into recipient object, return true on successful parsing
