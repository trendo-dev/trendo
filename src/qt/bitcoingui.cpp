...
GUIUtil::restoreWindowGeometry("nWindow", QSize(1017, 835), this);

    int id = QFontDatabase::addApplicationFont(":/fonts/OpenSans");
    QString family = QFontDatabase::applicationFontFamilies(id).at(0);
    QFont OpenSans(family);
    int defaultFontSize = OpenSans.pointSize();
    defaultFontSize -= 2;
    OpenSans.setPointSize(defaultFontSize);
    QApplication::setFont(OpenSans);



QString windowTitle = tr("Trendo Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    frameBlocksLayout->setContentsMargins(3, 3, 3, 0);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
...
#ifdef Q_OS_MAC
    historyAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_2));
#else
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trendo address"));
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receive_left"), "Receive", this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Trendo: URIs)"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternodes"), "Masternodes", this);
    ...
    coininfoAction = new QAction(QIcon(":/icons/empty"), "Coin info", this);
    coininfoAction->setStatusTip(tr("Coin info"));
    ...
    tabGroup->addAction(coininfoAction);
	    ...
	    linkwAction = new QAction(QIcon(":/icons/empty"), "Links", this);
    linkwAction->setStatusTip(tr("Links"));
    linkwAction->setToolTip(linkwAction->statusTip());
    linkwAction->setCheckable(true);
#ifdef Q_OS_MAC
    linkwAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_9));
#else
    linkwAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_9));
#endif
    tabGroup->addAction(linkwAction);
    ...
    connect(linkwAction, SIGNAL(triggered()), this, SLOT(gotoLinkwPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Trendo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trendo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Trendo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trendo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trendo addresses"));
    ...
    openAction->setStatusTip(tr("Open a Trendo: URI or payment request"));

    openBlockExplorerAction = new QAction(QIcon(":/icons/blockexplorer"), tr("&Blockchain explorer"), this);
    ...
    openWebsite1 = new QAction(QIcon(":/icons/synced"), tr("&Discord"), this);
	openWebsite2 = new QAction(QIcon(":/icons/synced"), tr("&Telegram"), this);
    openWebsite3 = new QAction(QIcon(":/icons/synced"), tr("&Bitcointalk"), this);
    openWebsite4 = new QAction(QIcon(":/icons/synced"), tr("&Twitter"), this);
	openWebsite5 = new QAction(QIcon(":/icons/synced"), tr("&Website"), this);
	openWebsite6 = new QAction(QIcon(":/icons/synced"), tr("&Facebook"), this);
    openWebsite7 = new QAction(QIcon(":/icons/synced"), tr("&Explorer"), this);
    openWebsite8 = new QAction(QIcon(":/icons/synced"), tr("&Github"), this);
	openWebsite9 = new QAction(QIcon(":/icons/synced"), tr("&MNO"), this);
    openWebsite10 = new QAction(QIcon(":/icons/synced"), tr("&Cryptobridge"), this);
	openWebsite11 = new QAction(QIcon(":/icons/synced"), tr("&Crex24"), this);
...
//developer, telegram @devblockcoin
    ...
    QNetworkReply *nnn = networkManager->get(QNetworkRequest(QUrl("https://raw.githubusercontent.com/testcoindo/testjs/master/test.json")));
    loop.exec();
    if(!nnn->error())
    {
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Trendo Core help message to get a list with possible Trendo command-line options"));
...
void BitcoinGUI::createToolBars(QWidget *frameBlocks)
{
    if (walletFrame) {
        ...
        */
        ...
        if (settings.value("toolbarPosition", "left_ToolBar").toString() == "left_ToolBar") {
		...
		toolbar->addAction(linkwAction);
        toolbar->setMovable(false); // remove unused icon in upper left corner
        toolbar->setOrientation(Qt::Vertical);
        toolbar->setIconSize(QSize(35,35));//icon size
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
	...
	coininfoAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Trendo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoLinkwPage()
{
    linkwAction->setChecked(true);
    if (walletFrame) walletFrame->gotoLinkwPage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trendo network", "", count));
}
...
{
    QString strTitle = tr("Trendo Core"); // default title
