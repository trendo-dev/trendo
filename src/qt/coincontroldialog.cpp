...
// Copyright (c) 2019 The TRND developers
...
// click on header
    ...
    ui->treeWidget->setColumnWidth(COLUMN_CHECKBOX, 65);
    ui->treeWidget->setColumnWidth(COLUMN_AMOUNT, 125);
    ui->treeWidget->setColumnWidth(COLUMN_LABEL, 140);
    ui->treeWidget->setColumnWidth(COLUMN_ADDRESS, 260);
...
//double lockCoin;
//extern double isLockedCoin_OVE;
//double isLockedCoin_OVE = lockCoin;
// Toggle lock state
...
void CoinControlDialog::updateLabels(WalletModel* model, QDialog* dialog)
{
    ...
    int nDisplayUnit = BitcoinUnits::TRND;
