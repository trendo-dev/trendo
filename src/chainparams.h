 ...
 * Trendo system. There are three: the main network on which people trade goods
...
public:
   ...
   // int GetFundFee() const { return nFundFee; }
    ...
    // const std::vector<unsigned char>& TrendoDevKey() const { return vTrendoDevKey; }
    // const std::vector<unsigned char>& TrendoFundKey() const { return vTrendoFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vTrendoDevKey;
