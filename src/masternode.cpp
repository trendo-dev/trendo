...
{
    if (blockHeight >= 129980) {
      switch(vin_val) {
          case 30000 * COIN: return 1;
          case 300000 * COIN: return 2;
          case 1500000 * COIN: return 3;
		  case 10000000 * COIN: return 4;
          case 50000000 * COIN: return 5;
      }
	}
    return 0;
}
...
*/
    ...
    // should be at least not earlier than block when 1000 Trendo tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = 0;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && mi->second) {
        CBlockIndex* pMNIndex = mi->second;                                                        // block for 1000 Trendo tx -> 1 confirmation
