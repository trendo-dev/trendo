...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Trendo Core trendo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  trendo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Trendo transaction") + "\n" +
                               "  trendo-tx [options] -create [commands]   " + _("Create hex-encoded Trendo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Trendo transaction
