...
#   c) node1 mines 32 blocks, so now node 0 has 60001trendo, node 1 has 4250trendo, node2 has none.
#   d) node0 sends 601 trendo to node2, in two transactions (301 trendo, then 300 trendo).
