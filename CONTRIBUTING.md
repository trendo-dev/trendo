Contributing to Trendo Core
============================

The Trendo Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Trendo Core project, and is not to be
confused with overall Trendo Network Protocol consensus changes.

Whether a pull request is merged into Trendo Core rests with the project merge
...
Patches that change Trendo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trendo consensus, it must have been
...
The project leader is the release manager for each Trendo Core release.
