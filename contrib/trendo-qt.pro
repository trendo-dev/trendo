...
RESOURCES += src/qt/trendo.qrc src/qt/trendo_locale.qrc

TRANSLATIONS += src/qt/locale/trendo_bg.ts \
                src/qt/locale/trendo_de.ts \
                src/qt/locale/trendo_en.ts \
                src/qt/locale/trendo_es.ts \
                src/qt/locale/trendo_fi.ts \
                src/qt/locale/trendo_fr.ts \
                src/qt/locale/trendo_it.ts \
                src/qt/locale/trendo_ja.ts \
                src/qt/locale/trendo_pl.ts \
                src/qt/locale/trendo_pt.ts \
                src/qt/locale/trendo_ru.ts \
                src/qt/locale/trendo_sk.ts \
                src/qt/locale/trendo_sv.ts \
                src/qt/locale/trendo_vi.ts \
                src/qt/locale/trendo_zh_CN.ts \
                src/qt/locale/trendo_zh_TW.ts
